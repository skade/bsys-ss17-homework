...
2. How would you run the scheduler to reproduce each of the examples in the chapter? Give to each figure number of the PDF chapter the corresponding simulator call.
